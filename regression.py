...
df['Adj Close'].plot(label='IXIC', figsize=(15, 9), title='Adjusted Closing Price', color='red', linewidth=1.0, grid=True)
plt.legend()
print("Plotted")
...
df['Adj Close'].plot(label='IXIC', figsize=(15,10), title='Adjusted Closing Price vs Moving Average', color='red', linewidth=1.0, grid=True)
